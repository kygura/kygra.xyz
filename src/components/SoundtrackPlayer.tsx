...
export const SoundtrackPlayer = () => {
  ...
  return (
    // Own provider rather than an app-shell one: nothing else on the site
    // uses tooltips, and a global provider puts Radix Tooltip in the
    // first-load bundle of every page.
    <TooltipProvider>
